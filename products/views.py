...
from .services import get_top_level_categories, get_subcategories, get_selectable_categories, get_category_names_by_ids, get_leaf_categories
...
def get_products_by_category(request, category_id):
    ...
    """
    from .services import get_product_by_id, get_products_for_categories
    from .data.category_hierarchy import get_category_path_by_id
    
    season = request.query_params.get('season', 'summer')
    
    # Get products for this category
    products_by_category = get_products_for_categories([int(category_id)], season=season)
