...
type PlanogramCategoriesSelectorProps = {
  watch: UseFormWatch<PlanogramFormData>;
  setValue: UseFormSetValue<PlanogramFormData>;
};

export function PlanogramCategoriesSelector({ watch, setValue }: PlanogramCategoriesSelectorProps) {
