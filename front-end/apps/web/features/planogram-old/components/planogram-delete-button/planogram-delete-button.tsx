...
import { usePlanogramForm, usePlanogramData } from '../../hooks';

export function PlanogramDeleteButton() {
    ...
    <div className='mt-8'>
      ...
      {deleteMutation.isError && (
        <Alert variant='destructive' className='mt-4'>
          <AlertDescription>{deleteMutation.error?.message || 'Failed to delete planogram'}</AlertDescription>
        </Alert>
      )}
    </div>
  );
