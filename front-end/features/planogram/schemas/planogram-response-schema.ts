...
export const planogramSchema = z.object({
  id: z.number(),
  name: z.string(),
  slug: z.string(),
  season: z.string(),
  season_display: z.string().optional(),
  categories: z.array(
    z.object({
      id: z.number(),
      slug: z.string(),
...
export const planogramResponseSchema = planogramSchema;

export type GridResponse = z.infer<typeof gridResponseSchema>;
export type Planogram = z.infer<typeof planogramSchema>;
export type PlanogramResponse = z.infer<typeof planogramResponseSchema>;
